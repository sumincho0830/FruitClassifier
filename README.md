...
### 1. 한계점
* **데이터 부족**: 학습을 위한 데이터가 충분히 많지 않아 일반화에 한계가 있을 수 있습니다. 또한, 특정 지역이나 환경에서 수집된 데이터로 학습한 경우 등 데이터가 편향되는 경우, 다른 환경에서는 모델 성능이 저하될 수 있습니다. 데이터의 다양성을 확보를 위한 추가적인 데이터 수집이 필요합니다. 
